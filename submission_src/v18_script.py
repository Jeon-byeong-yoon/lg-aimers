"""V18: 95% V11 tree ensemble + 5% regularized Logistic with extended OOF calibration.

Adds base_state and count_hand segment corrections on top of V17.
"""
...
def main():
    ...
    calibration = joblib.load("./model/v18_calibration.joblib")
