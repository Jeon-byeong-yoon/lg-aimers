"""V122: V117 with CatBoost reweighted to 0.27 and the V17 layer retired to zero."""
...
def main():
    ...
    catboost_meta = joblib.load("./model/v117_catboost_meta.joblib")
    catboost = CatBoostClassifier()
    catboost.load_model("./model/v117_catboost.cbm")
