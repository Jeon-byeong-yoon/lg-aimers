"""V93: V92 plus the current-season as-of reconstruction inside the Form HGB."""
...
def main():
    ...
    feature_models = joblib.load("./model/v93_feature_models.joblib")
    ...
    inseason_block = inseason_frame[feature_names()]
    ...
    # V93 keeps the V92 post-hoc drift term: validation showed the in-model
    # features and this global term are complementary, not redundant
    # (dropping it cut the monthly block win rate from 100% to 70%).
    prediction = np.clip(
