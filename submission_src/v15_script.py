"""V15: V11 ensemble plus fixed multi-segment OOF calibration."""
...
def main():
    ...
    calibration = joblib.load("./model/v15_segment_calibration.joblib")
    ...
    prediction = prediction + calibration["global_shift"]
