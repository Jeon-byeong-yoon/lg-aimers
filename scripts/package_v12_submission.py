"""Package V12 segment-calibrated submission."""
...
def main():
    files = {
        ...
        Path("artifacts/v12_segment_calibration.joblib"): "model/v12_segment_calibration.joblib",
    }
    output = Path("submissions/by_submitter/전병윤_RF_기준선/submit_v12.zip")
