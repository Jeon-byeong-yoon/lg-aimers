"""Package V92: V41 plus the current-season as-of drift correction (weight 0.20)."""
...
def main():
    files = {
        Path("submission_src/v92_script.py"): "script.py",
    ...
    output = Path("submissions/by_submitter/전병윤_RF_기준선/submit_v92.zip")
