"""Package V25 joint-feature ensemble submission."""
...
def main():
    files = {
        ...
        Path("artifacts/v25_calibration.joblib"): "model/v25_calibration.joblib",
    }
    output = Path("submissions/by_submitter/전병윤_RF_기준선/submit_v25.zip")
