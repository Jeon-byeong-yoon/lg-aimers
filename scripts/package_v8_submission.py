"""Package V8 calibrated candidate using the validated V6 model bundle."""
...
def main() -> None:
    files = {
        Path("submission_src/v8_script.py"): "script.py",
    ...
    output = Path("submissions/by_submitter/전병윤_RF_기준선/submit_v8_calibrated.zip")
