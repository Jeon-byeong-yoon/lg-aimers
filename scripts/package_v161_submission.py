"""Package V161: feature-side RELIABILITY_SCALE 150 -> 300.
...
def main():
    files = {
        ...
        Path("artifacts/v161_calibration.joblib"): "model/v25_calibration.joblib",
    ...
    output = Path("submissions/by_submitter/전병윤_RF_기준선/submit_v161.zip")
