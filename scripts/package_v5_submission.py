"""Package the locally validated V5 candidate."""
...
def main() -> None:
    files = {
        Path("submission_src/v5_script.py"): "script.py",
        ...
        Path("artifacts/v5_ensemble.joblib"): "model/v5_ensemble.joblib",
    }
    output = Path("submissions/by_submitter/전병윤_RF_기준선/submit_v5.zip")
