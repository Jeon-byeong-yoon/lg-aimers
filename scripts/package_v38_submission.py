"""Package V38 using the proven V25 inference contract."""
...
def main():
    files = {
        ...
        Path("artifacts/v38_calibration.joblib"): "model/v25_calibration.joblib",
    }
    output = Path("submissions/by_submitter/전병윤_RF_기준선/submit_v38.zip")
