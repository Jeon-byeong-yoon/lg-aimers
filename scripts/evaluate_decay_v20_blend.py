"""Re-evaluate the existing recency-decay HGB as a V17 diversity component."""
...
def main():
    ...
    decay_raw = joblib.load("artifacts/v7_decay_predictions.joblib")
    candidate = {year: item["decay_hgb"] for year, item in decay_raw.items()}
    frame = pd.read_csv(
    ...
    Path("artifacts/v20_decay_blend_metrics.json").write_text(
