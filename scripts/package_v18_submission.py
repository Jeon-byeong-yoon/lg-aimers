"""Package the V18 submission ZIP."""
...
def main():
    files = {
        Path("submission_src/v18_script.py"): "script.py",
        ...
        Path("artifacts/v18_calibration.joblib"): "model/v18_calibration.joblib",
    }
    output = Path("submissions/by_submitter/전병윤_RF_기준선/submit_v18.zip")
