"""Package V122: V117 with CatBoost reweighted to 0.27 and V17 retired.
...
def main():
    files = {
        Path("submission_src/v122_script.py"): "script.py",
        ...
        Path("artifacts/v122_calibration.joblib"): "model/v25_calibration.joblib",
    ...
    output = Path("submissions/by_submitter/전병윤_RF_기준선/submit_v122.zip")
