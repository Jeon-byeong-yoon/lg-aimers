"""Train final stable-form and contextual-Trackman HGB models for V25."""
...
def main():
    ...
    form_model, form_columns = hist_gbdt_pipeline(form_features)
    ...
    context_model, context_columns = hist_gbdt_pipeline(context_features)
    ...
    output = Path("artifacts/v25_feature_models.joblib")
