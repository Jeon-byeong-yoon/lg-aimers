"""Chronologically evaluate prior-season Trackman archetype features."""
...
from trackman_archetypes_v28 import add_trackman_archetypes
...
def main():
    ...
    for year in (2022, 2023, 2024):
        ...
        features = add_trackman_archetypes(features, trackman)
    ...
    Path("artifacts/v28_trackman_archetype_metrics.json").write_text(
        json.dumps(results, indent=2), encoding="utf-8"
    )
    joblib.dump(
        saved, "artifacts/v28_trackman_archetype_predictions.joblib", compress=3
    )
