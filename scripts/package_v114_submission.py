"""Package V114: V106 plus the entity-embedding network."""
...
def main():
    files = {
        Path("submission_src/v114_script.py"): "script.py",
        ...
        Path("artifacts/v114_calibration.joblib"): "model/v25_calibration.joblib",
    ...
    output = Path("submissions/by_submitter/전병윤_RF_기준선/submit_v114.zip")
