"""Package V106: V105 with the blend and drift weights refitted."""
...
def main():
    files = {
        ...
        Path("artifacts/v106_calibration.joblib"): "model/v25_calibration.joblib",
    ...
    output = Path("submissions/by_submitter/전병윤_RF_기준선/submit_v106.zip")
