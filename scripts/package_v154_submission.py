"""Package V154: a season-tracking prior for CatBoost plus an experience segment.
...
def main():
    files = {
        ...
        Path("artifacts/v154_calibration.joblib"): "model/v25_calibration.joblib",
    ...
    output = Path("submissions/by_submitter/전병윤_RF_기준선/submit_v154.zip")
