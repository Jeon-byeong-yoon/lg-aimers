"""Package V96: V93 with refitted blend and drift weights."""
...
def main():
    files = {
        Path("submission_src/v96_script.py"): "script.py",
        ...
        Path("artifacts/v96_calibration.joblib"): "model/v25_calibration.joblib",
    ...
    output = Path("submissions/by_submitter/전병윤_RF_기준선/submit_v96.zip")
