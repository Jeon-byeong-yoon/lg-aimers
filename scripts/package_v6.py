"""
Package submission_v6_final.zip for DACON submission.
Includes:
  - script.py
  - requirements.txt
  - model/ (all native model files, JSON configs, Platt params, weights)
...
ZIP_OUT_PATH = BASE_DIR / "scripts" / "submission_v6_final.zip"

# Write requirements.txt for evaluation server
...
print("Packaging submission_v6_final.zip...")
...
print(f"ZIP created successfully: {ZIP_OUT_PATH} ({size_mb:.2f} MB)")
