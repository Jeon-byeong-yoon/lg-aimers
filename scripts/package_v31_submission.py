"""Package V31 using the proven V25 inference contract."""
...
def main():
    files = {
        Path("submission_src/v25_script.py"): "script.py",
        ...
        Path("artifacts/v31_feature_models.joblib"): "model/v25_feature_models.joblib",
        Path("artifacts/v31_calibration.joblib"): "model/v25_calibration.joblib",
    }
    output = Path("submissions/by_submitter/전병윤_RF_기준선/submit_v31.zip")
