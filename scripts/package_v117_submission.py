"""Package V117: V114 plus CatBoost as a fifth blend component.
...
def main():
    files = {
        Path("submission_src/v117_script.py"): "script.py",
        ...
        Path("artifacts/v117_calibration.joblib"): "model/v25_calibration.joblib",
    ...
    output = Path("submissions/by_submitter/전병윤_RF_기준선/submit_v117.zip")
