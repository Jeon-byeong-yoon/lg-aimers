"""Test the stable-form HGB as a V17 ensemble component."""
...
def main():
    ...
    candidate = joblib.load("artifacts/v22_stable_form_predictions.joblib")
    frame = pd.read_csv(
    ...
    Path("artifacts/v22_blend_metrics.json").write_text(
