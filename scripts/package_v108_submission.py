"""Package V108: V106 with the drift term broadened to the failure-mode deltas."""
...
def main():
    files = {
        Path("submission_src/v108_script.py"): "script.py",
        ...
        Path("artifacts/v108_calibration.joblib"): "model/v25_calibration.joblib",
    ...
    output = Path("submissions/by_submitter/전병윤_RF_기준선/submit_v108.zip")
