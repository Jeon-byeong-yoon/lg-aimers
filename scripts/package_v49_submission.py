"""Package V49 using the 3-tier hierarchical platoon calibration."""
...
def main():
    files = {
        Path("submission_src/v49_script.py"): "script.py",
        ...
        Path("artifacts/v49_calibration.joblib"): "model/v25_calibration.joblib",
    }
    output = Path("submissions/by_submitter/전병윤_RF_기준선/submit_v49.zip")
