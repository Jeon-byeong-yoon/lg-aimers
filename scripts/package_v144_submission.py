"""Package V144: the pre-registered gate-violation probe (see V143).
...
def main():
    files = {
        Path("submission_src/v144_script.py"): "script.py",
        ...
        Path("artifacts/v144_calibration.joblib"): "model/v25_calibration.joblib",
        ...
        Path("artifacts/v144_catboost.cbm"): "model/v144_catboost.cbm",
        Path("artifacts/v144_catboost_meta.joblib"): "model/v144_catboost_meta.joblib",
    ...
    output = Path("submissions/by_submitter/전병윤_RF_기준선/submit_v144.zip")
