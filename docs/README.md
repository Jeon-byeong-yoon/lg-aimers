...
│   ├── 02_대회_방향성_및_목표.md       ← 공식 문제 정의·성공/실패 기준·공략법
...
| 02 | [02_대회_방향성_및_목표.md](./02_대회_방향성_및_목표.md) | 공식 문제 정의, control_success 성공·실패 기준, Phase 3 및 공략 로드맵 | ✅ 완료 |
...
| 08 | [08_V106_재현_가이드.md](./08_V106_재현_가이드.md) | Phase 3 코드 제출용 V106 재현 절차·환경·규정 준수 | ✅ 완료 |
